...
const NavbarToggleTheme = (className, actionStyle, iconSize) => {
  ...
  return (
    <InputText.Root className={twMerge('lg:col-span-1 lg:col-end-7 lg:justify-self-end lg:p-4',className)}>
        ...
        className={twMerge('text-skin-icon-secondary w-auto h-auto p-1 hover:scale-105 hover:text-skin-icon-secondary-hover lg:scale-100 lg:hover:scale-[1.1]', actionStyle)}
